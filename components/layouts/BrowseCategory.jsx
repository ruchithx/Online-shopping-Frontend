    ...
    <div className="py-6">
      <div className="flex items-center justify-between">
        <aside className="md:w-1/3 lg:w-1/4">
          <span
            className="flex items-center h-10 py-3 px-2 bg-[#4CAF50] text-sm text-white"
            style={{ width: '290px' }}
          >
            <svg
        ...
        <span className="flex-grow mx-4">
          <nav aria-label="Global">
            <ul className="flex items-center gap-16 text-sm">
              ...
              <li>
                <a
                  className="flex items-center text-sm font-medium text-gray-700 transition hover:text-gray-500/75"
                  href="#"
                >
                  <svg
                    className="h-5 w-5 mr-2"
