...
export default async function SupersaverSection({
  discountHaveProducts,
}: {
  discountHaveProducts: Product[];
}) {
  console.log(discountHaveProducts);
  return (
    <div className="pb-10  pl-16">
      ...
      <div className=" gap-8 flex flex-wrap">
        {discountHaveProducts?.map((product, index) => (
          <ProductCard
